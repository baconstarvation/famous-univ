...
[![Build Status](https://travis-ci.org/baconstarvation/testy.svg?branch=master)](https://travis-ci.org/baconstarvation/testy) [![Dependency Status](https://david-dm.org/baconstarvation/testy.svg)](https://david-dm.org/baconstarvation/testy) [![devDependency Status](https://david-dm.org/baconstarvation/testy/dev-status.svg)](https://david-dm.org/baconstarvation/testy#info=devDependencies)
...
## Release History
 * 2014-06-27   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)